        ...
        <span class="loaded_controls">
            ...
            <div class="row">
                ...
                <div class="column">
                    ...
                    <br />
                    <br />
                    width: <input type="number" v-model="maxWidth" style="width: 100%;" min="1" :max="data.target.naturalWidth" /><br />
                    <span v-if="widthError" class="widthError">
                        {{ data.target.naturalWidth }} Maximum
                    </span>
                </div>
  ...
  components: { Dropzone },
    ...
    methods: {
        ...
        updateImage(event) {
            ...
            if (this.maxWidth > this.data.target.naturalWidth) {
                this.widthError = true;
            } else {
                this.sendBack.maxWidth = this.maxWidth;
                this.$emit('returnImage', this.sendBack);
            }
        },
        fileUploaded (file, r) {
